...
const CONFIG = {
  ...
  tierNumber: "36",                  // R.IO tier number for current set (T36 = S2 Venomous Abyss)
  rioSeason: "season-mn-2",          // R.IO season slug for M+ cutoffs API
  wclPartitions: [
  ...
  raidSchedule: {
    days: ["Wednesday", "Thursday", "Friday"],  // Raid nights (full day names)
    startTime: "8:00 PM",
    endTime: "11:00 PM",
  ...
  // Raid Bosses — The Venomous Abyss (8 bosses + 1 lair boss)
  ...
  bosses: [
    ...
    {name: "Nymrissa Wavecaller", short: "Nymrissa"}
  ]
};
