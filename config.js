...
const CONFIG = {
  ...
  // Roster Filter - controls who counts as an active raider across the entire site.
  // Players who don't meet ALL of these criteria are excluded from rankings,
  // stats, recaps, and everything else. Tweak per tier as gear scales up.
  rosterFilter: {
    minIlvl: 270,                     // Minimum equipped item level
    minLevel: 90,                     // Minimum character level (90 = Midnight cap)
    requireParses: true               // Must have at least one WCL parse to be included
  },
