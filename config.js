...
const CONFIG = {
  ...
  // Parses are merged into the same raider data so they show up in the boss grid and GPS.
  supplementalZones: [
    { zoneId: 50, name: "Sporefall", bosses: ["Rotmire"] }
  ],
  ...
  bosses: [
    ...
    // Sporefall (12.0.7 supplemental raid)
    {name: "Rotmire", short: "Rotmire"}
  ]
};
