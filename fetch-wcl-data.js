...
async function main() {
  ...
  // Filter to actual raiders (has raid kills on current tier).
  // No ilvl filter here - raid kills are the gate. R.IO ilvl can be wrong
  // if the player logged out in PvP gear.
